...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Product Judgment | Not Assessed | L4 | CORE | No formal evidence recorded | Baseline Unknown | Phase 0 main baseline | — |
| AI UX / Human-AI Interaction | Not Assessed | L4 | CORE | No formal evidence recorded | Baseline Unknown | Phase 0 main baseline | — |
| Frontend Engineering (including Web / Frontend boundary) | Not Assessed | L4 | CORE | No formal evidence recorded | Baseline Unknown | Phase 0 main baseline | — |
| Workflow Design | Not Assessed | L4 | CORE | No formal evidence recorded | Baseline Unknown | Phase 0 basic judgment baseline | — |
...
| AI-assisted Engineering | Not Assessed | L4 | CORE | No formal evidence recorded | Baseline Unknown | Phase 0 main baseline | — |

## CORE-SUPPORT

| Ability | Current Status | Target Level | Priority | Evidence | Confidence | Next Verification | Last Verified |
| --- | --- | --- | --- | --- | --- | --- | --- |
| TypeScript | Not Assessed | L3-L4 | CORE-SUPPORT | No formal evidence recorded | Baseline Unknown | Phase 0 main baseline | — |
| React | Not Assessed | L3-L4 | CORE-SUPPORT | No formal evidence recorded | Baseline Unknown | Phase 0 foundation baseline | — |
| Structured Output | Not Assessed | L3 | CORE-SUPPORT | No formal evidence recorded | Baseline Unknown | Phase 0 main baseline | — |
| Tool Calling | Not Assessed | L3 | CORE-SUPPORT | No formal evidence recorded | Baseline Unknown | Phase 0 main baseline | — |
...
| Testing / Code Review | Not Assessed | L3-L4 | CORE-SUPPORT | No formal evidence recorded | Baseline Unknown | Phase 0 baseline | — |
...
| Ability | Current Status | Target Level | Priority | Evidence | Confidence | Next Verification | Last Verified |
| --- | --- | --- | --- | --- | --- | --- | --- |
| JavaScript | Not Assessed | L3 | SUPPORT | No formal evidence recorded | Baseline Unknown | Phase 0 main baseline | — |
| Next.js | Not Assessed | L3 | SUPPORT | No formal evidence recorded | Baseline Unknown | Phase 0 foundation baseline | — |
| HTTP / API | Not Assessed | L3 | SUPPORT | No formal evidence recorded | Baseline Unknown | Phase 0 main baseline | — |
| Async Programming | Not Assessed | L3 | SUPPORT | No formal evidence recorded | Baseline Unknown | Phase 0 main baseline | — |
| Git | Not Assessed | L3 | SUPPORT | No formal evidence recorded | Baseline Unknown | Phase 0 main baseline | — |
...
| RAG | Not Assessed | L3 | SUPPORT | No formal evidence recorded | Baseline Unknown | Phase 0 basic judgment baseline | — |
...
| Model Literacy | Not Assessed | L2-L3 | SUPPORT | No formal evidence recorded | Baseline Unknown | Phase 0 main baseline | — |
