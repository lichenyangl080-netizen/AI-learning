...
| Workflow Design | Provisional L2 | L4 | CORE | Can decompose a bounded task across deterministic code, Tool actions, fixed workflow steps, human approvals and constrained Agent autonomy; can explain and verify routing, sequencing, state transitions, revalidation, failure and recovery in a controlled local runtime. Sustained observability, broader failure ownership and judgment about when workflow is the wrong abstraction remain unverified. | Medium | P6 product-building workflow, delegation and failure ownership | 2026-09-07 |
| Context Engineering | Not Yet Assessed | L4 | CORE | P3 core instruction covered: distinguishes repository-held information from inference context, signal density from noise, context rot, progressive disclosure, compaction/eviction/rehydration, and source/scope/recency conflict handling. Practical context-package design and transfer remain unassessed. | Baseline Unknown | Current P3 practical validation or P6 context gathering and Agent delegation | 2026-09-08 |
| Tool / Capability Design | Not Yet Assessed | L4 | CORE | P3 core instruction covered: distinguishes Capability Design (problem, input/output, boundary, reuse and verification) from Tool Design (executable surface, schema, permission, error and return design), with allowlist and enforceable-constraint reasoning. Practical design evidence remains unassessed. | Baseline Unknown | Current P3 practical validation or P6 product capability/tool design | 2026-09-08 |
| Eval | Not Assessed | L4 | CORE | Can reason about representative Eval Sets, one-variable comparisons, guardrails, fresh cases, trace attribution, and Code/LLM Judge/Human roles. A Codex-assisted mutation/runtime-Oracle exercise showed basic verification use, but no independently owned Eval-driven improvement loop has been demonstrated. | Low | Current P3 practical validation or P6 independent Eval-driven improvement loop | 2026-09-08 |
| AI-assisted Engineering | Provisional L2 | L4 | CORE | Can define acceptance criteria for scoped Codex-assisted changes, reason about responsibility boundaries, perform targeted runtime and failure verification, and make final acceptance judgments. Systematic context packaging, delegation/steering, critical diff review, broader debugging ownership and independent verification design remain limited. | Medium | P6 end-to-end Specification, delegation, diff review, testing and correction loop | 2026-09-07 |
...
| Skill Design | Not Yet Assessed | L3-L4 | CORE-SUPPORT | P3 core instruction covered: a Skill packages repeatable principles, workflow, judgment criteria, stop conditions, failure behavior, resources and examples; progressive disclosure and stable-versus-volatile separation matter. Current Skill/Capability practice is ongoing and not completion evidence. | Baseline Unknown | Current P3 practical validation; P6 reusable product-building behavior when relevant | 2026-09-08 |
...
| Testing / Code Review | Not Assessed | L2-L3 | SUPPORT | Can perform targeted runtime verification of expected, failed, stale and recovery behavior, and distinguish build/type success from verified behavior. Systematic test design, regression coverage, critical diff review, independent debugging and verification strategy remain unverified. | Low | P6 key diff review, test design, failure injection and regression evidence | 2026-09-07 |
| Harness | Not Yet Assessed | L1-L2 | SUPPORT | P3 core instruction covered: Harness is the external environment and feedback loop that lets an Agent read, act, run, observe and be corrected; Tool and Skill have distinct responsibilities within it. No active harness design or modification evidence is established. | Baseline Unknown | P6 project-level tests, scripts, logs, browser or feedback-loop design | 2026-09-08 |
