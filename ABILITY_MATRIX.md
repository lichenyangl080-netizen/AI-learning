...
| AI UX / Human-AI Interaction | Provisional L2 | L4 | CORE | Loading/success/failure, approval and uncertainty reasoning; P1 runtime streaming evidence plus P2 user-verified pending approval, rejected, and invalidated workflow states. Broader AI UX and user validation remain unverified. | Medium | P2 retry / recovery UX verification, then P3 capability UX | 2026-09-07 |
| Workflow Design | Provisional L2 | L4 | CORE | Deterministic/model/tool/validator responsibility and perturbation adaptation; P2 integrates fixed Workflow with local Agent autonomy, routing / chaining / parallelization / gates, and runtime-enforced approval / revalidation. Learner personally verified normal approval, reject, and stale invalidation in the deterministic micro lab; retry / recovery transition evidence remains required. | Medium | P2 retry / recovery runtime verification | 2026-09-07 |
