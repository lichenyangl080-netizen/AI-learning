...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Product Judgment | Confirmed L2 | L4 | CORE | Product-semantic, deterministic-vs-LLM, risk/permission judgment, and basic cost / latency trade-offs are established. P4 adds conceptual integration-surface trade-offs across authority, completeness, permission risk, latency, cost, verifiability and complexity; problem framing, user value, AI opportunity, scope, success criteria, quality bar, ROI, adoption, rollout, and real discovery / metrics evidence remain unverified. | High | P4 integration-scope decisions; P7 product discovery and outcome evidence | 2026-09-09 |
...
| Integration Engineering | Not Yet Assessed | L2-L3 | CORE-SUPPORT | P4 conceptual exposure: compares structured API, MCP, Browser / Computer Use, RAG and persistent state by authority, completeness, permission risk, latency, cost, verifiability and complexity. No real integration ownership evidence. | Baseline Unknown | P4 natural external integration practice | 2026-09-09 |
...
| Memory / State | Not Yet Assessed | L2-L3 | CORE-SUPPORT | P3 conceptual exposure distinguishes current Context, runtime State, durable Memory and historical record; P4 adds conceptual product boundaries among conversation, files, database, Owner / Writer and copy / sync direction. No assessed implementation or capability conclusion. | Baseline Unknown | P4 natural persistent-state practice | 2026-09-09 |
...
| HTTP / API | Confirmed L1 | L2-L3 | SUPPORT | Can trace basic request and response behavior and distinguish transport success from invalid runtime data or failure states. P4 adds API-contract risk awareness for completeness / pagination, rate limits, freshness / cache, versioning / deprecation and error semantics; external integration remains unverified. | Medium | P4 natural external API practice | 2026-09-09 |
...
| Database / Data Modeling | Not Yet Assessed | L2 | SUPPORT | P4 conceptual exposure distinguishes conversation / context, files and database by reuse, scale and structured read / write needs; separates runtime state from persistent state and clarifies Owner, Writer and copy / sync direction. No implementation evidence. | Baseline Unknown | P4 natural persistent-state practice | 2026-09-09 |
| Authentication / Authorization | Not Yet Assessed | L2 | SUPPORT | P4 conceptual exposure distinguishes identity from permission, least privilege from login, approval from authorization, and UI hiding from execution-layer enforcement. Object-level authorization, OAuth / RBAC depth and real implementation remain unverified. | Baseline Unknown | P4 natural permission-boundary practice; P5 depth | 2026-09-09 |
| RAG | Confirmed L1 | L2-L3 | SUPPORT | Distinguishes knowledge retrieval from authoritative real-time state; P4 adds Retrieval Miss, Wrong Retrieval, Stale Source and Synthesis Error attribution, plus grounding and citation limits. Implementation and Eval evidence remain unverified. | Medium | P4 natural retrieval / grounding practice | 2026-09-09 |
| MCP | Not Yet Assessed | L2 | SUPPORT | P4 conceptual exposure distinguishes MCP as an Agent-facing interface from ordinary APIs, and compares structured Tool surfaces with GUI / Computer Use by stability, verification, permission control and reuse. No MCP implementation evidence. | Baseline Unknown | P4 natural MCP / integration practice | 2026-09-09 |
